...
import ServicesList from "@/components/servlist"
import type { Metadata } from "next"


export const metadata: Metadata = {
    title: "خدماتنا المتميزة - تطوير البرمجيات والحلول الرقمية | آفاق العالم الرقمي",
    description:
        "اكتشف خدماتنا المتنوعة في تطوير المواقع، تطبيقات الجوال، المتاجر الإلكترونية، التسويق الرقمي، وإدارة وسائل التواصل الاجتماعي. حلول رقمية متكاملة لنجاح أعمالك.",
    keywords:
        "تطوير مواقع، تطبيقات أندرويد، متاجر إلكترونية، تسويق رقمي، سوشيال ميديا، تصميم هويات، تجربة المستخدم، آفاق العالم الرقمي",
    openGraph: {
        title: "خدماتنا المتميزة - حلول رقمية متكاملة",
        description: "نقدم خدمات تطوير البرمجيات والحلول الرقمية المتطورة لتحقيق أهدافك التجارية",
        url: "https://www.digitalworldhorizon.com/services",
        siteName: "آفاق العالم الرقمي",
        locale: "ar_SA",
        type: "website",
    },
    alternates: {
        canonical: "https://www.digitalworldhorizon.com/services",
    },
}

export default function ServicesPageeee() {
    return (
        <main>
            <ServicesList />
        </main>
