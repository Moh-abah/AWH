            ...
            <div className="grid md:grid-cols-2 gap-10 ">
                ...
                <div>
                    ...
                    <ul className="list-disc list-inside space-y-2 text-gray-700">
                        ...
                        <li>الالتزام بالمواعيد وتحقيق النتائج المذهلة .</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                        نسعى لنكون من ارقى الشركات التقنية في المنطقة اولا ثم العالم ثانيا ، رائدين في تقديم حلول رقمية مبتكرة تساعد عملائنا على النجاح والنمو في عالم متغير سريع.
