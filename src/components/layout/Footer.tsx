    ...
    return (
        <footer className="bg-gradient-to-t from-gray-900 via-gray-800 to-gray-900 text-gray-300 pt-14 pb-8">
            <div className="container mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
                ...
                <div className="space-y-4">
                    <Link href="/" className="flex items-center gap-3">
                        <Image src="/images/logo.png" alt="AWH Logo" width={48} height={48} className="rounded-full" />
                        <span className="text-white font-bold text-2xl tracking-wide">AWH</span>
                    </Link>
                ...
                <div>
                    ...
                    <div className="space-y-3 text-gray-300 text-sm md:text-base">
                        <p>📞 <a href="tel:+967780090882" className="hover:text-blue-400 transition duration-300">+967 78 009 0882</a></p>
                        <p>✉️ <a href="mailto:musst92@gmail.com" className="hover:text-blue-400 transition duration-300">musst92@gmail.com</a></p>
                    </div>
                </div>
            ...
            <div className="border-t border-gray-700 mt-12 pt-6 text-center text-gray-500 text-xs sm:text-sm select-none">
                © {new Date().getFullYear()} AWH – كل الحقوق محفوظة.
            </div>
        </footer>
    );
}
