        ...
        <div className="relative min-h-screen">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-16 space-y-20">
                ...
                >
                    ...
                    <p className="text-lg leading-relaxed text-800 max-w-xl">
                        شركة AWH هي شركة تقنية إبداعية متكاملة، تقدم خدمات تطوير المواقع والتطبيقات، التصميم الجرافيكي، الهوية البصرية، التسويق الإلكتروني، وحلول السوشيال ميديا، لتساعد العلامات التجارية على النمو والتأثير باحترافية.
